		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World",
									"targetURL": "#sapbtphelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtphelloworld-display": {
								"semanticObject": "sapbtphelloworld",
								"action": "display",
								"description": "An SAP Fiori Hello World application.",
								"title": "Hello World",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.helloworld",
									"url": sap.ui.require.toUrl("sap/btp/helloworld")
								}
							}
						}
					}
